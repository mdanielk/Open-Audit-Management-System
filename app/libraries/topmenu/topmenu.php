...
*/
class Topmenu extends MD_app{
	public function show_topmenu(){
		...
		$topmenu ='<header>				
				...
				<nav>
					<div class="nav-wrapper">
					  <div class="logo"><a href="'.__HOMEPAGE__.'" class="brand-logo"></a></div>
					  <ul class="right">
						<li><a href="">Home</a></li>';
				...
				$topmenu.='<li><a class="dropdown-trigger" href="#!" data-target="dropdownProfile">Login As {USERNAME}!<i class="material-icons right">arrow_drop_down</i></a></li>
					  </ul>
					</div>
				</nav>
				</div>
